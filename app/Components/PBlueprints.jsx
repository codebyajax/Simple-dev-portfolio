...
export default function PBlueprints({ img, video, name, type, range, status, fword, sword, stack1, stack2, stack3, stack4, stack5, stack6 }) {
    return (
        <article key={name} className="project padding flex flex-col mb-3">
            <div className="p-2  select-none cursor-pointer head flex justify-between">
                <div className="main flex gap-2">
                    <figure className="size-14 p-1 rounded-[10px] overflow-hidden  border dark:border-white/10 flex items-center justify-center">
                        <img
